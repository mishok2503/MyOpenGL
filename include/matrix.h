...
public:
    ...
    const Vector<2, size_t> size() const {
        return Vector<2, size_t>(W, H);
    }
...
template<size_t W, size_t H, typename T> Matrix<H, W, T> operator +(Matrix<H, W, T> left, const Matrix<H, W, T>& right)
{
...
template<size_t H1, size_t W1, size_t W2, typename T> Matrix<H1, W2, T> operator *(const Matrix<H1, W1, T>& left, const Matrix<W1, W2, T>& right)
{
    Matrix<H1, W2, T> res;
    for (size_t i = H1; i--; )
...
template<size_t W, size_t H, typename T> Vector<H, T> operator *(const Matrix<H, W, T>& left, const Vector<W, T>& right)
{
    Vector<H, T> res;
...
template<size_t W, size_t H, typename T> Matrix<H, W, double> operator *(Matrix<H, W, T> left, const double right)
{
